...
Проверка на соответствие суммы оплаты и суммы заказа остается на вашей совести.
Для удобства обработки таких ситуаций существует зарезервирваное исключение `Unitpay::Controller::RuntimeException`.
При этом в ответе будет передан текст вашей ошибки.
